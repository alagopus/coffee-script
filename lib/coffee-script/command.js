...
(function() {
  var BANNER, CoffeeScript, SWITCHES, coffee_exts, compileJoin, compileOptions, compilePath, compileScript, compileStdio, file, forkNode, fsa0, helpers, hidden, joinTimeout, lint, loadRequires, notSources, optionParser, optparse, opts, os, outputPath, parseOptions, printLine, printTokens, printWarn, removeSource, sourceCode, sources, usage, version, wait, writeJs,
  ...
  compilePath = (function(){ function _compilePath(source, topLevel, base) {
    var code, f, files, index, _compilePath, _ref, _ref1, _ref2, _ref3;
    if (!file.exists(source)) {
      if (topLevel && (_ref = file.extension(source), __indexOf.call(coffee_exts, _ref) < 0)) {
    ...
    } else if (topLevel || (_ref3 = file.extension(source), __indexOf.call(coffee_exts, _ref3) >= 0)) {
