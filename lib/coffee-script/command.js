...
(function() {
  var BANNER, CoffeeScript, EventEmitter, SWITCHES, compileJoin, compileOptions, compilePath, compileScript, compileStdio, exists, file, forkNode, fsa0, helpers, hidden, joinTimeout, lint, loadRequires, notSources, optionParser, optparse, opts, os, outputPath, parseOptions, printLine, printTokens, printWarn, removeSource, sourceCode, sources, timeLog, unwatchDir, usage, version, wait, watch, watchDir, watchers, writeJs;
  ...
  printLine = function(line) {
    return system.stdout.write(line + '\n');
  };

  printWarn = function(line) {
    return system.stderr.write(line + '\n');
  };
  ...
  unwatchDir = function(source, base) {
    var prevSources, toRemove, _i, _len;
