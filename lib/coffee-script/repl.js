...
(function() {
  ...
  error = (function(){ var _fn = function _519error(err) {
    var _fn;
    return stdout.write((err.stack || err.toString()) + '\n');
  }; var _520error = null; return _fn})();

  ACCESSOR = /\s*([\w\.]+)(?:\.(\w*))$/;

  SIMPLEVAR = /(\w+)$/i;

  autocomplete = (function(){ var _fn = function _521autocomplete(text) {
    var _fn;
    return completeAttribute(text) || completeVariable(text) || [[], text];
  }; var _522autocomplete = null; return _fn})();

  completeAttribute = (function(){ var _fn = function _523completeAttribute(text) {
  ...
  }; var _524completeAttribute = null; return _fn})();

  completeVariable = (function(){ var _fn = function _525completeVariable(text) {
  ...
  }; var _526completeVariable = null; return _fn})();

  getCompletions = (function(){ var _fn = function _527getCompletions(prefix, candidates) {
    ...
    return _results;
  }; var _528getCompletions = null; return _fn})();

  process.on('uncaughtException', error);

  backlog = '';

  run = (function(){ var _fn = function _529run(buffer) {
    ...
    return repl.prompt();
  }; var _530run = null; return _fn})();

  if (stdin.readable && stdin.isRaw) {
    pipedInput = '';
    repl = {
      prompt: (function(){ var _fn = function _531prompt() {
        var _fn;
        return stdout.write(this._prompt);
      }; var _532prompt = null; return _fn})(),
      setPrompt: (function(){ var _fn = function _533setPrompt(p) {
        var _fn;
        return this._prompt = p;
      }; var _534setPrompt = null; return _fn})(),
      input: stdin,
      output: stdout,
      on: (function(){ var _fn = function _535on() {}; var _536on = null; return _fn})()
    };
