...
(function() {
  ...
  error = (function(){ var _fn = function _259error(err) {
    var _fn;
    return stdout.write((err.stack || err.toString()) + '\n');
  }; var _259error = null; return _fn})();

  ACCESSOR = /\s*([\w\.]+)(?:\.(\w*))$/;

  SIMPLEVAR = /(\w+)$/i;

  autocomplete = (function(){ var _fn = function _260autocomplete(text) {
    var _fn;
    return completeAttribute(text) || completeVariable(text) || [[], text];
  }; var _260autocomplete = null; return _fn})();

  completeAttribute = (function(){ var _fn = function _261completeAttribute(text) {
    var all, candidates, completions, key, match, obj, prefix, _fn, _i, _len, _ref;
  ...
  }; var _261completeAttribute = null; return _fn})();

  completeVariable = (function(){ var _fn = function _262completeVariable(text) {
    var candidates, completions, free, key, keywords, r, vars, _fn, _i, _len, _ref;
  ...
  }; var _262completeVariable = null; return _fn})();

  getCompletions = (function(){ var _fn = function _263getCompletions(prefix, candidates) {
    ...
    return _results;
  }; var _263getCompletions = null; return _fn})();

  process.on('uncaughtException', error);

  backlog = '';

  run = (function(){ var _fn = function _264run(buffer) {
    var code, returnValue, _, _fn;
    ...
    return repl.prompt();
  }; var _264run = null; return _fn})();

  if (stdin.readable && stdin.isRaw) {
    pipedInput = '';
    repl = {
      prompt: (function(){ var _fn = function _265prompt() {
        var _fn;
        return stdout.write(this._prompt);
      }; var _265prompt = null; return _fn})(),
      setPrompt: (function(){ var _fn = function _266setPrompt(p) {
        var _fn;
        return this._prompt = p;
      }; var _266setPrompt = null; return _fn})(),
      input: stdin,
      output: stdout,
      on: (function(){ var _fn = function _267on() {}; var _267on = null; return _fn})()
    };
